...
class SignUpHealthWorkerScreen extends StatefulWidget {
  const SignUpHealthWorkerScreen({super.key});

  @override
  State<SignUpHealthWorkerScreen> createState() => _SignUpHealthWorkerScreenState();
}

class _SignUpHealthWorkerScreenState extends State<SignUpHealthWorkerScreen> {
  ...
  final organizationTEController = TextEditingController();
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SignUpTextField(label: 'Organization', hint: 'BRAC / Govt / NGO Name', iconData: Icons.business, textEditingController: organizationTEController, validator: Validators.organization,),
                  DropdownMenuWidget(
                    value: trainingStatus,
                    label: "Status",
                    icon: Icons.school,
                    items: const ["Trained", "In Training", "Certified"],
                    onChanged: (value) {
                      setState(() {
                        trainingStatus = value;
                      });
                    },
                    validator: Validators.trainingStatus,
                  ),
