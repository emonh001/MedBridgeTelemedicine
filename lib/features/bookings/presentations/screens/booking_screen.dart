        ...
        actions: [
          ...
          Padding(
            ...
            child: CircleAvatar(
              ...
              child: const Icon(Icons.person, color: Color(0xFF1A6BFF), size: 18),
            ),
          ),
        ],
      ),
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.person, color: Color(0xFF1A6BFF), size: 32),
                  ),
            ...
            Row(
              children: [
                Expanded(
                  child: _buildInputField('AGE', '26'),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: _buildDropdownField('GENDER', _selectedGender, ['Male', 'Female', 'Other'],
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: hint,
            hintStyle:
            const TextStyle(color: Color(0xFFCBD5E0), fontSize: 13),
            filled: true,
            fillColor: Colors.white,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            if (isSelected)
              const Icon(Icons.check_circle, color: Color(0xFF1A6BFF), size: 20),
          ],
        ),
      ),
    );
